...
static std::vector<std::string> games_path {"./games/lib_menu/lib_menu.so", "./games/lib_arcade_pacman/lib_arcade_pacman.so", "./games/lib_arcade_nibbler/lib_arcade_nibbler.so"};
